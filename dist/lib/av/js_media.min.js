    ...
    return function(e) {
        ...
        var l, f, h = function() {
            ...
            _ = {
                ...
                browserType: h,
                browser: {
                    isFirefox: "firefox" === h.browser,
                    isChrome: "chrome" === h.browser,
                    isEdge: "edge" === h.browser,
                    isSafari: "safari" === h.browser
                },
                isOpera65: function() {
                    try {
                ...
                isSDKSupportMultiThread: (f = (0, o.default)(a.default.mark(function e() {
                ...
                isSDKSupportSIMD: (l = (0, o.default)(a.default.mark(function e() {
                    var t;
                    return a.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if ("object" === ("undefined" == typeof WebAssembly ? "undefined" : (0, r.default)(WebAssembly))) {
                                    e.next = 2;
                                    break
                                }
                                return e.abrupt("return", !1);
        ...
        var r = i(n(8)),
            ...
            u = function() {
                function e() {
                    (0, a.default)(this, e), this.handler = !1, this.wasm = !1, this.socket = !1
                }
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var i, t = O.default.userNodeList || [],
                n = e.concat(t);
            O.default.userNodeList = f.default.removeDuplicates(n, function(e, t) {
                return e.userid !== t.userid
            }), [D.WORKER_TYPE.AUDIO_ENCODE, D.WORKER_TYPE.AUDIO_DECODE, D.WORKER_TYPE.VIDEO_ENCODE, D.WORKER_TYPE.VIDEO_DECODE, D.WORKER_TYPE.SHARING_ENCODE, D.WORKER_TYPE.SHARING_DECODE].forEach((i = (0, d.default)(s.default.mark(function e(t) {
                var n;
                return s.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        ...
                        case 18:
                            g("setUserNodeListToWorker init success", t), ge(t, {
                    ...
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 8:
                                ...
                                break;
                            case 13:
                                return e.next = 15, u.default.all([C(t.videoDecWorkerPath), C(t.videoEncWorkerPath)]);
                            case 15:
                                i = e.sent, O.default.videoDecResponseText = i[0], O.default.videoEncResponseText = i[1];
                            case 18:
                                O.default.mediaSDKHandle = t.handle, he(0, null);
                            case 20:
                            case "end":
                                return e.stop()
                        }
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    var i;
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return O.default.localVideoEncMGR || (O.default.localVideoEncMGR = new l.VideoMGR), O.default.videoEncWorkerPath = t, e.next = 4, C(t);
                            case 4:
                                return i = e.sent, O.default.videoEncResponseText = i, he(0, null, n), e.next = 9, P(n);
                            case 9:
                                fe();
                            case 10:
                            case "end":
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    ...
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return O.default.localVideoDecMGR || (O.default.localVideoDecMGR = new l.VideoMGR), O.default.videoDecWorkerPath = t, e.next = 4, C(t);
                            case 4:
                                return i = e.sent, O.default.videoDecResponseText = i, le(0, null, n), e.next = 9, P(n);
                            case 9:
                                ce();
                            case 10:
                            case "end":
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return ee(), O.default.localAudioEncMGR || (O.default.localAudioEncMGR = new l.AudioMGR), O.default.audioEncWorkerPath = t, e.next = 5, C(t);
                            case 5:
                                O.default.audioEncodeResponse = e.sent, Ae(0, n), w(n).then(function() {
                                    Se()
                                }).catch(function(e) {
                                    g(e)
                                });
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return ee(), O.default.localAudioDecMGR || (O.default.localAudioDecMGR = new l.AudioMGR), O.default.audioDecWorkerPath = t, e.next = 5, C(t);
                            case 5:
                                O.default.audioDecodeResponse = e.sent, Ee(0, null, n), V(n).then(function() {
                                    _e()
                                }).catch(function(e) {
                                    g(e)
                                });
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return O.default.localSharingDecMGR || (O.default.localSharingDecMGR = new l.SharingMGR), O.default.localMouseDecMGR || (O.default.localMouseDecMGR = new l.SharingMGR), O.default.sharingDecWorkerPath = t, e.next = 5, C(t);
                            case 5:
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return O.default.localSharingEncMGR || (O.default.localSharingEncMGR = new l.SharingMGR), O.default.sharingEncWorkerPath = t, e.next = 4, C(t);
                            case 4:
                                O.default.sharingEncodeResponse = e.sent, z(n), F(n).then(function() {
                                    B()
                                }).catch(function(e) {
                                    g(e)
                                });
                    ...
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 8:
                                ...
                                break;
                            case 13:
                                return e.next = 15, u.default.all([C(t.audioEncWorkerPath), C(t.audioDecWorkerPath)]).then(function(e) {
            ...
            O.default.localSharingPara || (O.default.localSharingPara = t), O.default.localSharingDecMGR || (O.default.localSharingDecMGR = new l.SharingMGR), O.default.localMouseDecMGR || (O.default.localMouseDecMGR = new l.SharingMGR), ie(e), $(0)
        }, t.setSharingEngineInitProperties = function(e, t) {
            O.default.localSharingPara ? (0, o.default)(O.default.localSharingPara, t) : O.default.localSharingPara = t, ie(e)
        }, t.JsAudioEngine_Init = function(e, t) {
            O.default.localAudioPara || (O.default.localAudioPara = t), O.default.localAudioDecMGR || (O.default.localAudioDecMGR = new l.AudioMGR), O.default.localAudioEncMGR || (O.default.localAudioEncMGR = new l.AudioMGR), ne(e), Ae(0)
        }, t.setAudioEngineInitProperties = function(e, t) {
            O.default.localAudioPara ? (0, o.default)(O.default.localAudioPara, t) : O.default.localAudioPara = t, ne(e)
        }, t.setVideoEngineInitProperties = function(e, t) {
            var n;
            O.default.localVideoPara ? (0, o.default)(O.default.localVideoPara, t) : O.default.localVideoPara = t, n = e, O.default.Video_WebSocket_Ip_Address || (O.default.Video_WebSocket_Ip_Address = n)
            ...
            if (O.default.localSharingEncMGR) {
                var o, u = O.default.localSharingEncMGR.map.get(e);
                u && (t ? (o = {
            ...
            if (O.default.localAudioDecMGR) {
                ...
                if (r) {
                    if (r.residue) {
                        if (r.residue.buffer.length > n) return a = r.residue.buffer.slice(0, n), r.residue.buffer = r.residue.buffer.slice(n), se(r.residue.ntptime), a;
                        if (r.residue.buffer.length === n) return a = r.residue.buffer, se(r.residue.ntptime), r.residue = null, a;
                        a = r.residue.buffer, se(r.residue.ntptime), r.residue = null, n -= a.length
                    }
                    for (var o = r.dequeue(); o && o.buffer.length < n;) se(o.ntptime), a = T(a, o.buffer), n -= o.buffer.length, o = r.dequeue();
                    if (o && (se(o.ntptime), 0 !== n && o.buffer.length === n ? a = T(a, o.buffer) : 0 !== n && o.buffer.length > n && (a = T(a, o.buffer.slice(0, n)), r.residue = {
            ...
            I.default.add_monitor2(e)
        }, t.Stop_Monitor = function() {
            window.removeEventListener("error", De), clearInterval(O.default.monitorIntervalHandle), I.default.send_instant_monitor()
        ...
        }, t.pushMessageToWorker = ge, t.isVideoEncodeHandleReady = function() {
            return null !== Oe(D.WORKER_TYPE.VIDEO_ENCODE)
        }, t.transportOfflineCanvas = function(e, t) {
            var n = O.default.SPECIAL_ID;
            if (O.default.localVideoEncMGR) {
                var i = O.default.localVideoEncMGR.map.get(n);
                i && i.postMessage({
        ...
        var a = r(n(65)),
            ...
            v = n(189),
            O = r(n(33)),
            g = (0, h.default)("sdk.engine");

        function m() {
            return (m = (0, d.default)(s.default.mark(function e(t, n, i, r, a) {
                var u, d, c, l, f;
                return s.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                        ...
                        case 21:
                            d = t.slice(0, t.lastIndexOf("/")), c = "wasmUrl = '" + d + "/';" + u, l = {}, D.workerStartTypeToDevToolWorkerNameEnum[r] && (0, o.default)(l, {
        ...
        function R(e, t, n, i, r) {
            ! function(e, t, n, i, r) {
                ...
                var r = O.default.SPECIAL_ID;
                t && t.Add(r, e), e.onmessage = function(e) {
                    n(e),
                        function(e, t) {
                            var n = t.data;
                            [function(e, t) {
                                -1 !== [D.WORKER_TYPE.AUDIO_ENCODE, D.WORKER_TYPE.VIDEO_ENCODE, D.WORKER_TYPE.SHARING_ENCODE].indexOf(e) && t.status === c.AES_GCM_IV_CALLBACK_FROM_WASM && (g("allWorkersListener_AES_IV", e, t), O.default.Notify_APPUI_SAFE(c.AES_GCM_IV_RESPONSE, {
                                    workerType: e,
        ...
        function P(e) {
            return new u.default(function(t, n) {
                var i = setInterval(function() {
                    ...
                    O.default.Video_WebSocket_Ip_Address && O.default.localVideoPara && O.default.localVideoPara.confId && (t(O.default.Video_WebSocket_Ip_Address), clearInterval(i))
                }, 1e3 / 24)
            })
        }
                            ...
                            case 0:
                                return e.abrupt("return", new u.default(function(e, n) {
                                    var i = setInterval(function() {
                                        ...
                                        O.default.localAudioPara && r && O.default.isAudioEncodeWASMOK && (clearInterval(i), e(!0))
                                    }, 1e3 / 24)
                                }));
                            case 1:
                            case "end":
                            ...
                            case 0:
                                return e.abrupt("return", new u.default(function(e, n) {
                                    var i = setInterval(function() {
                                        ...
                                        O.default.localAudioPara && r && O.default.isAudioDecodeWASMOK && (clearInterval(i), e(!0))
                                    }, 1e3 / 24)
                                }));
                            case 1:
                            case "end":
        ...
        function F(e) {
            return new u.default(function(t, n) {
                var i = setInterval(function() {
                    if (e && e.isDestroy) return clearInterval(i), n("sdk destroy");
                    O.default.localSharingEncMGR.Get(O.default.SPECIAL_ID) && O.default.isSharingEncodeWASMOK && O.default.localSharingPara && (clearInterval(i), t(!0))
                }, 1e3 / 24)
            })
        }
        ...
        function H(e) {
            return new u.default(function(t, n) {
                var i = setInterval(function() {
                    if (e && e.isDestroy) return clearInterval(i), n("sdk destroy");
                    O.default.localSharingDecMGR.Get(O.default.SPECIAL_ID) && O.default.isSharingDecodeWASMOK && O.default.localSharingPara && (clearInterval(i), t(!0))
                }, 1e3 / 24)
            })
        }
        ...
        function B() {
            if (O.default.localSharingEncMGR) {
                ...
                if (e && O.default.isSharingEncodeWASMOK && !O.default.isSharingEncodePostStart) {
                    ...
                    I.default.add_monitor2("STN" + t);
                    var n = null;
                    O.default.ivObj && (n = O.default.ivObj[D.WORKER_TYPE.SHARING_ENCODE], n = f.default.stringSplitByComma2Buffer(n)), e.postMessage({
                        command: "startMedia",
                        encode: !0,
                        websocket_ip_address: O.default.Sharing_WebSocket_Ip_Address,
                        confId: O.default.localSharingPara.userid,
        ...
        function j(e) {
            ...
            try {
                ! function() {
                    if (t.status === c.Sharing_Data)(function(e) {
                    ...
                    else if (t.status === c.Sharing_Width_And_Height_Info) A.default.publish(c.SHARING_PARAM_INFO_FROM_SOCKET, {
                        body: {
                            width: t.logicWidth,
                    ...
                    else if (t.status === c.SHARING_RENDER_MONITOR_LOG) I.default.add_monitor2(t.data);
                        ...
                        if (O.default.isSharingPlayWork) {
                            ...
                            O.default.mediaSDKHandle.SharingRenderObj.Get_Mouse_Data_From_Queue(c)
                        }
                    }(t.mouse_ssrc, t.data, t.mouse_timestamp, t.mouse_width, t.mouse_height, t.mouse_x, t.mouse_y, t.mLogic_w, t.mLogic_h, t.sync_id);
                    else if (t.status === c.SHARING_DECODE_MESSAGE) O.default.Notify_APPUI(c.SHARING_DECODE_MAX_SIZE, {
                        ssrc: t.ssrc,
                        size: t.size
                    });
                    else if (t.status === c.Sharing_Dec_WASM_OK) I.default.add_monitor("SDWS"), O.default.isSharingDecodeWASMOK = !0, O.default.sharingDecInitInstance.setWasmSuccess();
                    else if (t.status === c.Sharing_Dec_WASM_FAILED) I.default.add_monitor("SDWF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), p.SharingInit.publishSharingDecodeFailedEvent();
                    else if (t.status === c.Sharing_Handle_OK) I.default.add_monitor("SDHS"), O.default.sharingDecInitInstance.setHanderSuccess();
                    else if (t.status === c.Sharing_Handle_FAILED) I.default.add_monitor("SHHF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), p.SharingInit.publishSharingDecodeFailedEvent();
                    else if (t.status === c.Sharing_Dec_WebSocket_OK) I.default.add_monitor("SDSS"), O.default.sharingDecInitInstance.setSocketSuccess();
                    else if (t.status === c.Sharing_Dec_WebSocket_FAILED) I.default.add_monitor("SDSF"), O.default.isInitialFailed || (O.default.sharingDecInitInstance.isSocketInitSuccess() ? O.default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.default.isInitialFailed = !0)), p.SharingInit.publishSharingDecodeFailedEvent();
                    else if (t.status == c.MONITOR_MESSAGE) O.default.monitorDecodeSharing = t;
                    else if (t.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                        var e = O.default.localSharingDecMGR.map.get(O.default.SPECIAL_ID);
                        q(t.url, e)
                    } else t.status == c.APP_TROUBLESHOOTING_INFO ? (O.default.monitorSharingDecodeAPPInfo = t, O.default.Notify_APPUI(c.MONITOR_LOG, {
                        evt: 4167,
                        seq: 1,
                        body: {
                            data: O.default.monitorSharingDecodeAPPInfo.data
                        }
                    }), O.default.monitorSharingDecodeAPPInfo = null) : t.status == c.WCL_TROUBLESHOOTING_INFO && I.default.add_monitor("SD" + t.data)
                }()
            } catch (e) {
                g.error(e)
            }
        ...
        function Q(e) {
            ...
            try {
                ! function() {
                    if (t.status === c.Sharing_Data) ae(t.data);
                    else if (t.status === c.SHARING_GET_IMAGE_DATA_WRONG) I.default.add_monitor("GIDF");
                    else if (t.status === c.Sharing_Dec_WASM_OK) I.default.add_monitor("SEWS"), O.default.isSharingEncodeWASMOK = !0, O.default.sharingEncInitInstance.setWasmSuccess();
                    else if (t.status === c.Sharing_Dec_WASM_FAILED) I.default.add_monitor("SEWF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), p.SharingInit.publishSharingEncodeFailedEvent();
                    else if (t.status === c.Sharing_Handle_OK) I.default.add_monitor("SEHS"), O.default.sharingEncInitInstance.setHanderSuccess();
                    else if (t.status === c.Sharing_Handle_FAILED) I.default.add_monitor("SEHF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), p.SharingInit.publishSharingEncodeFailedEvent();
                    else if (t.status === c.Sharing_Dec_WebSocket_OK) I.default.add_monitor("SESS"), O.default.sharingEncInitInstance.setSocketSuccess();
                    else if (t.status === c.Sharing_Dec_WebSocket_FAILED) I.default.add_monitor("SEWF"), O.default.isInitialFailed || (O.default.sharingEncInitInstance.isSocketInitSuccess() ? O.default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.default.isInitialFailed = !0)), p.SharingInit.publishSharingEncodeFailedEvent();
                    else if (t.status == c.Video_Capture_Tick) O.default.mediaSDKHandle.Process_Sharing();
                    else if (t.status == c.MONITOR_MESSAGE) O.default.monitorEncodeSharing = t;
                    else if (t.status == c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                        var e = O.default.localSharingEncMGR.map.get(O.default.SPECIAL_ID);
                        q(t.url, e)
                    } else t.status == c.APP_TROUBLESHOOTING_INFO ? (O.default.monitorSharingEncodeAPPInfo = t, O.default.Notify_APPUI(c.MONITOR_LOG, {
                        evt: 4167,
                        seq: 1,
                        body: {
                            data: O.default.monitorSharingEncodeAPPInfo.data
                        }
                    }), O.default.monitorSharingEncodeAPPInfo = null) : t.status == c.WCL_TROUBLESHOOTING_INFO && I.default.add_monitor("SE" + t.data)
                }()
            } catch (e) {
                g.error(e)
            }
        ...
        function Y(e) {
            ...
            try {
                ! function() {
                    if (t.status === c.VIDEO_DATA_DROP_RATIO);
                    else if (t.status === c.VIDEO_RESOLUTION_UPDATE) O.default.Notify_APPUI(c.CURRENT_VIDEO_RESOLUTION, {
                        width: t.width,
                        height: t.height
                    });
                    else if (t.status === c.VIDEO_RENDER_MONITOR_LOG) I.default.add_monitor2(t.data);
                    else if (t.status === c.VIDEO_DROP_RATIO_FROM_WCL) {
                        var e = t.data;
                        A.default.triggerSync(c.VIDEO_DATA_FROM_WORKER, e)
                    ...
                    else if (t.status === c.Video_Dec_WASM_OK) I.default.add_monitor("VDWS"), O.default.isVideoDecodeWASMOK = !0, O.default.videoDecInitInstance.setWasmSuccess();
                    else if (t.status === c.DECODE_MESSAGE) O.default.Notify_APPUI(c.VIDEO_DECODE_MAX_SIZE, {
                        ssrc: t.ssrc,
                        size: t.size
                    });
                    else if (t.status === c.Video_Dec_WASM_FAILED) I.default.add_monitor("VDWF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), _.VideoInit.publishDecodeInitFAILEDEvent();
                    else if (t.status === c.Video_Dec_Handle_OK) I.default.add_monitor("VDHS"), O.default.videoDecInitInstance.setHanderSuccess();
                    else if (t.status === c.Video_Dec_Handle_FAILED) I.default.add_monitor("VDHF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), _.VideoInit.publishDecodeInitFAILEDEvent();
                    else if (t.status === c.Video_Dec_WebSocket_OK) I.default.add_monitor("VDSS"), O.default.videoDecInitInstance.setSocketSuccess();
                    else if (t.status === c.Video_Dec_WebSocket_FAILED) I.default.add_monitor("VDSF"), O.default.isInitialFailed || (O.default.videoDecInitInstance.isSocketInitSuccess() ? O.default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.default.isInitialFailed = !0)), _.VideoInit.publishDecodeInitFAILEDEvent();
                    else if (t.status == c.MONITOR_MESSAGE) O.default.monitorDecodeVideo = t;
                    else if (t.status == c.APP_TROUBLESHOOTING_INFO) O.default.monitorVideoDecodeAPPInfo = t, O.default.Notify_APPUI(c.MONITOR_LOG, {
                        evt: 4167,
                        seq: 1,
                        body: {
                            data: O.default.monitorVideoDecodeAPPInfo.data
                        ...
                        q(t.url, n)
                    } else t.status == c.WCL_TROUBLESHOOTING_INFO && I.default.add_monitor("VD" + t.data)
                }()
            } catch (e) {
                g.error(e)
            }
            O.default.videoDecInitInstance.checkInitSuccess() && _.VideoInit.publishDecodeInitSuccessEvent()
        }
        ...
        function X(e) {
            ...
            try {
                ! function() {
                    if (t.status === c.VIDEO_DATA_DROP_RATIO);
                    ...
                    else if (t.status === c.Video_Enc_WASM_OK || t.status === c.Video_Dec_WASM_OK) I.default.add_monitor("VEWS"), le(0, null), O.default.isVideoEncodeWASMOK = !0, O.default.videoInitInstance.setWasmSuccess();
                    else if (t.status === c.Video_Enc_WASM_FAILED) I.default.add_monitor("VEWF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), _.VideoInit.publishEncodeInitFAILEDEvent();
                    else if (t.status === c.Video_Enc_Handle_OK || c.Video_Dec_Handle_OK === t.status) I.default.add_monitor("VEHS"), O.default.videoInitInstance.setHanderSuccess();
                    else if (t.status === c.Video_Enc_Handle_FAILED || c.Video_Dec_Handle_FAILED === t.status) I.default.add_monitor("VEHF"), O.default.isInitialFailed || (O.default.Notify_APPUI && O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), _.VideoInit.publishEncodeInitFAILEDEvent();
                    else if (t.status === c.Video_Enc_WebSocket_OK || c.Video_Dec_WebSocket_OK === t.status) I.default.add_monitor("VESS"), O.default.videoInitInstance.setSocketSuccess();
                    ...
                    else if (t.status === c.Video_Capture_Tick) O.default.mediaSDKHandle.Process_Video();
                    else if (t.status == c.MONITOR_MESSAGE) O.default.monitorEncodeVideo = t;
                    else if (t.status == c.APP_TROUBLESHOOTING_INFO) O.default.monitorVideoEncodeAPPInfo = t, O.default.Notify_APPUI(c.MONITOR_LOG, {
                        evt: 4167,
                        seq: 1,
                        body: {
                            data: O.default.monitorVideoEncodeAPPInfo.data
                        ...
                        q(t.url, n)
                    } else t.status == c.WCL_TROUBLESHOOTING_INFO && I.default.add_monitor("VE" + t.data)
                }()
            } catch (e) {
                g.error(e)
            }
            O.default.videoInitInstance.checkInitSuccess() && _.VideoInit.publishEncodeInitSuccessEvent()
        }
        ...
        function J(e) {
            ...
            try {
                ! function() {
                    ...
                    } else if (t.status === c.Audio_Enc_WASM_OK || t.status === c.Audio_Dec_WASM_OK) I.default.add_monitor("ADWS"), O.default.isAudioDecodeWASMOK = !0, O.default.audioDecInitInstance.setWasmSuccess();
                    else if (t.status === c.Audio_Dec_WASM_FAILED) I.default.add_monitor("ADWF"), O.default.isInitialFailed || O.default.Notify_APPUI && (O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                    else if (t.status === c.Audio_Dec_Handle_OK) I.default.add_monitor("ADHS"), O.default.audioDecInitInstance.setHanderSuccess();
                    else if (t.status === c.Audio_Dec_Handle_FAILED) I.default.add_monitor("ADHF"), O.default.isInitialFailed || O.default.Notify_APPUI && (O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                    else if (t.status === c.Audio_Dec_WebSocket_OK) I.default.add_monitor("ADSS"), O.default.audioDecInitInstance.setSocketSuccess();
                    else if (t.status === c.Audio_Dec_WebSocket_FAILED) I.default.add_monitor("ADSF"), O.default.isInitialFailed || (O.default.audioDecInitInstance.isSocketInitSuccess() ? O.default.Notify_APPUI_SAFE(c.AUDIO_WEBSOCKET_BROKEN, null) : (O.default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.default.isInitialFailed = !0)), E.AudioInit.publishAudioDecodeFAILEDEvent();
                    else if (6 === t.status);
                    else if (-6 === t.status) O.default.isInitialFailed || O.default.Notify_APPUI && (O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                    else if (t.status == c.MONITOR_MESSAGE) O.default.monitorDecodeAudio = t;
                    else if (t.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                        var r = O.default.localAudioDecMGR.map.get(O.default.SPECIAL_ID);
                        q(t.url, r)
                    } else t.status == c.WCL_TROUBLESHOOTING_INFO && I.default.add_monitor("AD" + t.data)
                }()
            } catch (e) {
                g.error(e)
            }
            ...
            if (O.default.localAudioDecMGR) {
                try {
                    ! function() {
                        ...
                        else if (n.status == c.AUDIO_ENCODED_DATA) A.default.triggerSync(c.AUDIO_DATA_FROM_WORKER, n.data);
                        else if (n.status === c.Audio_Enc_WASM_OK || n.status === c.Audio_Dec_WASM_OK) I.default.add_monitor("AEWS"), Ee(0, null), O.default.isAudioEncodeWASMOK = !0, O.default.audioEncodeInitInstance.setWasmSuccess();
                        else if (n.status === c.Audio_Enc_WASM_FAILED || n.status === c.Audio_Dec_WASM_FAILED) I.default.add_monitor("AEWF"), O.default.isInitialFailed || O.default.Notify_APPUI && (O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), E.AudioInit.publishAudioEncodeFAILEDEvent();
                        else if (n.status === c.Audio_Dec_Handle_OK) I.default.add_monitor("AEHS"), O.default.audioEncodeInitInstance.setHanderSuccess();
                        else if (n.status === c.Audio_Dec_WebSocket_OK) I.default.add_monitor("AESS"), O.default.audioEncodeInitInstance.setSocketSuccess();
                        else if (n.status === c.Audio_Dec_WebSocket_FAILED) I.default.add_monitor("AESF"), O.default.isInitialFailed || (O.default.audioEncodeInitInstance.isSocketInitSuccess() ? O.default.Notify_APPUI_SAFE(c.AUDIO_WEBSOCKET_BROKEN, null) : (O.default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.default.isInitialFailed = !0)), E.AudioInit.publishAudioEncodeFAILEDEvent();
                        else if (n.status === c.Audio_Enc_Handle_FAILED || n.status === c.Audio_Dec_Handle_FAILED) I.default.add_monitor("AEHF"), O.default.isInitialFailed || O.default.Notify_APPUI && (O.default.Notify_APPUI(c.INIT_FAILED, null), O.default.isInitialFailed = !0), E.AudioInit.publishAudioEncodeFAILEDEvent();
                        else if (n.status === c.Audio_Mute) O.default.Notify_APPUI && O.default.Notify_APPUI(c.AUDIO_ZERO_DATA, null);
                        else if (n.status === c.AUDIO_DELAY) O.default.indexDbObject.put(n.delay, "delay"), O.default.openIndexFlag && O.default.indexDbObject.select("delay");
                        else if (n.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                            var r = O.default.localAudioEncMGR.map.get(O.default.SPECIAL_ID);
                            q(n.url, r)
                        } else n.status == c.WCL_TROUBLESHOOTING_INFO ? I.default.add_monitor("AE" + n.data) : (n.status, c.AUDIO_CLIPPING)
                    }()
                } catch (e) {
                    g.error(e)
                }
        ...
        function z(e) {
            ...
            if (O.default.localSharingEncMGR)
                if (O.default.isSharingEncodeThreadStart) setTimeout(B, 100);
                    ...
                    R(O.default.sharingEncWorkerPath, O.default.localSharingEncMGR, Q, D.WORKER_TYPE.SHARING_ENCODE, e)
                }
        }
        ...
        function $(e) {
            ...
            if (O.default.localSharingDecMGR)
                if (O.default.isSharingDecodeThreadStart) setTimeout(K, 100);
                    ...
                    R(O.default.sharingDecWorkerPath, O.default.localSharingDecMGR, j, D.WORKER_TYPE.SHARING_DECODE, e)
                }
        }
        ...
        function ae(e) {
            O.default.localSharingDecMGR && ("sharingPara" == e.type && (I.default.add_monitor("SHPA"), A.default.publish(c.SHARING_PARAM_INFO_FROM_SOCKET, e.data), O.default.Notify_APPUI(c.SHARING_PARA, e.data)), O.default.isSharingPlayWork && O.default.localSharingDecMGR.PutData(e))
        }
        ...
        function oe(e, t, n) {
            if (e = O.default.SPECIAL_ID, O.default.isAudioPlayWork && O.default.localAudioDecMGR) {
                ...
                i.enqueue(c);
                var l = ue(e);
                if (l > O.default.audioBufferSize + 2 && g("the length is " + l), l > 50)
                    for (var f = l - O.default.audioBufferSize; f >= 0;) de(e), f--;
        ...
        function ce() {
            if (O.default.localVideoDecMGR) {
                ...
                e && O.default.isVideoDecodeWASMOK && !O.default.isVideoDecodePostStart && O.default.localVideoPara ? (e.postMessage({
                    ...
                    multiThreadNum: 1
                }), O.default.isVideoDecodePostStart = !0) : O.default.isVideoDecodePostStart || setTimeout(ce, 100)
            }
        }
        ...
        function le(e, t, n) {
            ...
            if (O.default.SPECIAL_ID, O.default.localVideoDecMGR)
                if (O.default.isVideoDecodeThreadStart) setTimeout(ce, 100);
                else {
                    if (O.default.isVideoDecodeThreadStart = !0, "" == O.default.videoDecWorkerPath) return;
                    R(O.default.videoDecWorkerPath, O.default.localVideoDecMGR, Y, D.WORKER_TYPE.VIDEO_DECODE, n)
                }
        }
        ...
        function fe() {
            if (O.default.localVideoEncMGR) {
                ...
                if (e && O.default.isVideoEncodeWASMOK && !O.default.isVideoEncodePostStart && O.default.localVideoPara) {
                    ...
                    var n = null;
                    O.default.ivObj && (n = O.default.ivObj[D.WORKER_TYPE.VIDEO_ENCODE], n = f.default.stringSplitByComma2Buffer(n)), e.postMessage({
                        command: "startMedia",
        ...
        function he(e, t, n) {
            ...
            O.default.SPECIAL_ID, O.default.localVideoEncMGR && (O.default.isVideoEncodeThreadStart || (O.default.isVideoEncodeThreadStart = !0, R(O.default.videoEncWorkerPath, O.default.localVideoEncMGR, X, D.WORKER_TYPE.VIDEO_ENCODE, n)))
        }
        ...
        function _e() {
            if (O.default.localAudioDecMGR) {
                ...
                } else O.default.isAudioDecodePostStart || setTimeout(_e, 100)
            }
        }
        ...
        function Ee(e, t, n) {
            ...
            O.default.SPECIAL_ID, O.default.localAudioDecMGR && (O.default.isAudioDecodeThreadStart || (O.default.isAudioDecodeThreadStart = !0, R(O.default.audioDecWorkerPath, O.default.localAudioDecMGR, J, D.WORKER_TYPE.AUDIO_DECODE, n)))
        }
        ...
        function Se() {
            ...
            if (O.default.localAudioPara && e && O.default.isAudioEncodeWASMOK && !O.default.isAudioEncodePostStart) {
                var t = null;
                if (O.default.ivObj && (t = O.default.ivObj[D.WORKER_TYPE.AUDIO_ENCODE], t = f.default.stringSplitByComma2Buffer(t)), e.postMessage({
                        command: "startMedia",
        ...
        function Ae(e, t) {
            ...
            O.default.SPECIAL_ID, O.default.isAudioEncodeThreadStart || (O.default.isAudioEncodeThreadStart = !0, R(O.default.audioEncWorkerPath, O.default.localAudioEncMGR, Z, D.WORKER_TYPE.AUDIO_ENCODE, t))
        }
            ...
            try {
                if (I.default && e) {
                    var t = ["ERR:", e.message, "f"].join(""),
                        n = I.default.checkIsNecessaryExceptionLogAndReturnRepeatTimes(t);
                    n.isNecessary ? (g("error repeat ".concat(n.repeatNumber), t), I.default.add_monitor(t + "(repeat:".concat(n.repeatNumber, ")"))) : g("error but ignore", e.message)
                }
            } catch (e) {
        ...
        function Oe(e) {
            var t = new a.default;
            t.set(D.WORKER_TYPE.AUDIO_DECODE, O.default.localAudioDecMGR), t.set(D.WORKER_TYPE.AUDIO_ENCODE, O.default.localAudioEncMGR), t.set(D.WORKER_TYPE.VIDEO_DECODE, O.default.localVideoDecMGR), t.set(D.WORKER_TYPE.VIDEO_ENCODE, O.default.localVideoEncMGR), t.set(D.WORKER_TYPE.SHARING_DECODE, O.default.localSharingDecMGR), t.set(D.WORKER_TYPE.SHARING_ENCODE, O.default.localSharingEncMGR);
            var n = O.default.SPECIAL_ID,
                i = t.get(e);
            ...
            return function() {
                return (0, d.default)(s.default.mark(function e(t, n) {
                    ...
                    return s.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (i = u.length > 2 && void 0 !== u[2] ? u[2] : "PUSH_MESSAGE_FROM_MAIN_TO_WORKER", r = u.length > 3 && void 0 !== u[3] && u[3], a = u.length > 4 && void 0 !== u[4] && u[4], e.prev = 3, o = Oe(t)) {
                                    e.next = 15;
                                    break
                                }
                                if (a) {
                            ...
                            case 11:
                                return g.warn("worker handle not ready, waiting!", t, n, i), e.next = 14, ve(t);
                            case 14:
                                o = e.sent;
                            case 15:
                                r ? o.postMessage({
                                ...
                                break;
                            case 18:
                                e.prev = 18, e.t0 = e.catch(3), g.warn("try to push message to workerType:".concat(t, ", but it does not exist. Command: ").concat(i, "; Message: ").concat(n)), g.warn(e.t0);
                            case 22:
                            case "end":
                                return e.stop()
                        }
                    ...
                    A(function() {
                        for (var i = e._v, r = 1 == e._s, a = 0, o = function(t) {
                                var n, a, o, u = r ? t.ok : t.fail,
                                    ...
                                    c = t.domain;
                                try {
                                    u ? (r || (2 == e._h && V(e), e._h = 1), !0 === u ? n = i : (c && c.enter(), n = u(i), c && (c.exit(), o = !0)), n === t.promise ? d(g("Promise-chain cycle")) : (a = b(n)) ? a.call(n, s, d) : s(n)) : d(i)
                                } catch (e) {
                                    c && !o && c.exit(), d(e)
                                }
                            }; n.length > a;) o(n[a++]);
        ...
        F || (u((P = function() {
            ...
            return this._k
        }), C.f = J, R.f = Y, n(92).f = m.f = Z, n(37).f = q, n(61).f = z, a && !n(29) && u(W, "propertyIsEnumerable", q, !0), _.f = function(e) {
            return j(h(e))
        }), o(o.G + o.W + o.F * !F, {
            Symbol: P
        });
            ...
            k.prototype = {
                            ...
                            case 0:
                                if (this.isFocusNow()) {
                                    for (n = (t.clipboardData || window.clipboardData).getData("text"), m("_pasteOnDocument", n), i = [], r = 0; r < n.length; r++)
                                        for (a = n[r], o = v.default.encode(a), u = 0; u < o.length; u++) i.push(o.charCodeAt(u));
                ...
                setSrcOffsetXY: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                        ...
                        n = Math.floor(e),
                        i = Math.floor(t);
                    if (!(0, D.default)(n) && !(0, D.default)(i)) throw new Error("the value of source offset x or y is not correct");
                    ...
                    if (this.blobSocket) {
                        ...
                        this.blobSocket.addEventListener("message", (t = (0, _.default)(h.default.mark(function t(n) {
                            ...
                            return h.default.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return i = n.data, t.next = 3, O.default.readBlobAsBuffer(i, i.size);
                                    case 3:
                                        if (r = t.sent, a = new Int8Array(r), 88 !== (o = a[0])) {
                                            t.next = 14;
                                            break
                                        }
                                        return u = i.slice(8), t.next = 10, O.default.readBlob(u);
                                    case 10:
        ...
        var i = n(20),
            ...
            T = r(n(103));
        n(206);
        var M, N, P, b, k, w, L, V, U, x, G, W, F, H, K = r(n(71)),
            B = n(207),
            j = r(n(208)),
            Q = r(n(209)),
            Y = r(n(200)),
            ...
            q = function e() {
                ...
                }).bind(this), this.isInitVideoDataChannel = !1, this.isInitAudioDataChannel = !1, this.rtcPeerConnectionList = [], this.isDestroy = !1, t.ivObj && (_.default.ivObj = t.ivObj)
            };
        q.buildNumber = 5321, q.version = "2.1.5321", q.prototype = {
            ...
            initSharingDecode: (V = (0, s.default)(u.default.mark(function e(t, n, i) {
                ...
                return u.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        ...
                        case 16:
                            return e.next = 18, v.Sharing.waitSharingDecodeResult();
                        case 18:
                            return e.abrupt("return", e.sent);
                        case 19:
                        case "end":
            ...
            initSharingEncode: (L = (0, s.default)(u.default.mark(function e(t, n, i) {
                ...
                return u.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        ...
                        case 15:
                            return e.next = 17, v.Sharing.waitSharingEncodeResult();
                        case 17:
                            return e.abrupt("return", e.sent);
                        case 18:
                        case "end":
                    ...
                    for (;;) switch (e.prev = e.next) {
                        ...
                        case 18:
                            return S = [], n instanceof Array ? S = n : S.push(n), I = this.videoCaptureValue.canvasCtrlList, D = I.filter(function(e) {
                                ...
                                return e.dom
                            }), this.switchCanvasForVideoCapture(D), e.abrupt("break", 174);
                        case 24:
                        ...
                        case 29:
                            if (this.isStartVideoCapture) X.warn("video capture is already started, do not call again.");
                                ...
                                n.canvasCtrl = n.canvasCtrlList[0].dom, this.captureVideoOutputCanvasDomList = [].concat(n.canvasCtrl), f.default.browser.isSafari ? ((v = document.createElement("video")).setAttribute("style", "position:fixed;top:-10000px;left:-10000px;visibility:hidden;"), document.body.appendChild(v), n.videoCtrl = v) : n.videoCtrl = f.default.getDocumentHandle(n.video), this.videoCaptureValue = n, this.Start_Video_Capture()
                            }
                            return e.abrupt("break", 174);
                        case 31:
                            return O = this, e.abrupt("return", new a.default(function(e, t) {
                                try {
                                    ...
                                    O.isStartVideoCapture && O.Stop_Video_Capture(), _.default.Notify_APPUI(h.STOP_VIDEO_CAPTURE_SUCCESS, null), e(!0)
                                } catch (e) {
                                    _.default.Notify_APPUI(h.STOP_VIDEO_CAPTURE_FAILED, null), t(e)
                                }
                            }));
                        case 34:
                            return 0 == this.audioRenderArray.length && (this.audioRenderArray.push(n), this.Start_Audio_Play()), e.abrupt("break", 174);
                        case 36:
                            ...
                            return e.abrupt("break", 174);
                        case 38:
                            return this.UnMuteAudio(), e.abrupt("break", 174);
                        case 40:
                            return this.MuteAudio(), e.abrupt("break", 174);
                        case 42:
                        ...
                        case 64:
                            return this.currentactive != n.ssrc && (this.currentactive = n.ssrc, _.default.CurrentSSRC = this.currentactive), E.Notify_Audio_Thread_CurrentSSRC(_.default.CurrentSSRC), this.isSupportOffscreenCanvas ? (s = _.default.SPECIAL_ID, _.default.localVideoDecMGR && (c = _.default.localVideoDecMGR.map.get(s)) && (p = {
                                ...
                                isSupportOffscreenCanvas: !1,
                                jsMediaEngine: E
                            }))), this.VideoRenderObj.Change_Current_SSRC(this.currentactive)), e.abrupt("break", 174);
                        case 68:
                            return this.currentshareactive != n.ssrc && (this.currentshareactive = n.ssrc), this.isSupportOffscreenCanvas ? (s = _.default.SPECIAL_ID, _.default.localSharingDecMGR && (c = _.default.localSharingDecMGR.map.get(s)) && (p = {
                                ...
                                PubSub: A.default,
                                jsMediaEngine: E
                            }))), this.SharingRenderObj.Change_Current_SSRC(this.currentshareactive)), e.abrupt("break", 174);
                        case 71:
                            return this.Stop_Audio_Play(), e.abrupt("break", 174);
                        case 73:
                            return this.Meeting_Fail_Over(n.audio_websocket_address, n.video_websocket_address), e.abrupt("break", 174);
                        case 75:
                        ...
                        case 79:
                            ...
                            return e.abrupt("return");
                        case 82:
                            return n && (E.Notify_Audio_Thread_Status(_.default.SPECIAL_ID, h.AUDIO_START), this.EndAudioMediaStream(), this.Remove_Audio_Capture(), this.audioCapture = n, this.Start_Audio_Capture(), E.Reset_Aec()), e.abrupt("break", 174);
                        case 84:
                            ...
                            return _.default.AudioNode = null, this.audioCtx && (this.audioCtx.close(), this.isCaputureNodeConnect = !1), this.audioCtx = null, this.audioCapture = null, this.audioPlay = !1, e.abrupt("break", 174);
                        case 94:
                            try {
                                _.default.monitorAudioUserID = n.CaptureAudioInfo.ssrc, E.Update_Audio_Encrpt(_.default.e2eencrypt), this.Remove_Audio_Play(), this.Remove_Audio_Capture(), this.EndAudioMediaStream(), E.Notify_Audio_Thread_Status(_.default.SPECIAL_ID, h.AUDIO_START), this.audioCtx && (this.audioCtx.close(), this.isCaputureNodeConnect = !1), this.audioCtx = new(window.AudioContext || window.webkitAudioContext), this.audioCtx.sampleRate != this.sampleRate && (this.sampleRate = this.audioCtx.sampleRate, E.Modify_Audio_SampleRate(this.sampleRate)), this.isSupportAudioWorklet ? (O = this, this.audioCtx.audioWorklet.addModule(O.audioWorkletJsPath).then(function() {
                                    if (_.default.AudioNode = new l.default(O.audioCtx), f.default.browser.isChrome && !f.default.isAndroidBrowser()) {
                                        var e = O.audioCtx.createMediaStreamDestination();
                                        _.default.AudioNode.connect(e), O.audioDomNode || (O.audioDomNode = new Audio), O.audioDomNode.srcObject = e.stream, O.audioSpeakerValue ? O.audioDomNode.setSinkId(O.audioSpeakerValue).catch(function(e) {
                                            K.default.add_monitor("AODF"), _.default.Notify_APPUI(h.AUDIO_SPEAKER_SET_ERROR, null)
                                        }) : O.audioDomNode.setSinkId("default").catch(function(e) {
                                            K.default.add_monitor("AODF"), _.default.Notify_APPUI(h.AUDIO_SPEAKER_SET_ERROR, null)
                                        }), O.audioDomNode.play()
                                    } else _.default.AudioNode.connect(O.audioCtx.destination);
                                    ...
                                    if (_.default.AudioNode.port.postMessage({
                                        ...
                                        }, [t.port1]), E.Notify_Audio_Thread_Msg_Channel(t, i), O.Start_Audio_Play(), P.isSupportOffscreenCanvas) {
                                        var r = new MessageChannel;
                                        _.default.AudioNode.port.postMessage({
                                            status: "decodeAudioPortWithVideo"
                                        }, [r.port2]), E.Notify_Audio_Video_Thread_Msg_Channel(r)
                                    }
                                    n.CaptureAudio && (O.audioCapture = n.CaptureAudioInfo, O.Start_Audio_Capture(), P.firstSetDelay && (P.firstSetDelay = !1, E.Reset_Aec(), E.Set_Aec_Delay()))
                            ...
                            return e.abrupt("break", 174);
                        case 96:
                            return X("sdk start remote control 1"), T = this.sharingWidthAndHeightInfo, M = new g.default((0, d.default)({
                                dom: document
                        ...
                        case 170:
                            return e.abrupt("break", 174);
                        case 171:
                            return E.setUserNodeListToWorker(n), e.abrupt("break", 174);
                        case 173:
